		...
		App.Object.runOnUiThread(new Runnable() {
			...
			public void run() {
				try {
					...
					switch (image) {
					case Warning:
						builder.setIcon(AppModel.Object.GetDrawableResource(R.drawable.exclamation_icon));
						break;
					case Error:
						builder.setIcon(AppModel.Object.GetDrawableResource(R.drawable.hand_icon));
						break;
					case Question:
						builder.setIcon(AppModel.Object.GetDrawableResource(R.drawable.question_icon));
						break;
					default:
						builder.setIcon(AppModel.Object.GetDrawableResource(R.drawable.info_icon));
						break;
					}
